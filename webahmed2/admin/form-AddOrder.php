<?php require_once "../core/PointDeVenteC.php";
            $PtVC=new PtVC();
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
               ...
               <form class="form-horizontal" role="form" method="POST" action="addOrder.php" id="addOrder">
                                                    
													<div class="form-group row">
                                                        <label class="col-2 col-form-label">ID Client</label>
                                                        <div class="col-md-10">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input class="form-control" type="date" name="OED" id="OED" >
                                                        </div>
                                                    </div>
													<td></br>   </td>
