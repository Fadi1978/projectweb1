...
if (isset($_POST['deleteID'])){
	...
	$CID=$OrderC->getOrderCID($_POST['deleteID']);
	$n2="Random@Client.com";
	$PID=$OrderC->getOrderPID($_POST['deleteID']);
	$ProdName=$Produit1C->recupererProduitNom($PID);
      ...
      $to  = $n2;
     $subject = 'Votre Commande est Supprimée';
     $message = '
