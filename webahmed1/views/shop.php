    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="item-entry">
              <a href="#" class="product-item md-height bg-gray d-block">
                <img src="images/prod_11.png" alt="Image" class="img-fluid">
              </a>
          ...
          <div class="col-md-6">
            <h2 class="text-black">collier</h2>
            ...
            <p><form method="POST" action="addCart.php">
                         <button type="submit" class="btn">AJOUTER AU PANIER</button>
                        <input type="hidden" name="id_produit" value="31">
