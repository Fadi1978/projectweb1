...
<tr>
<td></td>
<td><input type="hidden" name="id_ini" value="<?PHP echo $_GET['id_categorie'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
	$promotion=new promotion($_POST['id_categorie'],$_POST['date_debut'],$_POST['date_fin'],$_POST['id_categorie']);
