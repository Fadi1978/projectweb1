...
<?php
$bdd = new PDO("mysql:host=127.0.0.1;dbname=Balti_optic;charset=utf8", "root", "");
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <td width="63%" height="46"><input type="text" name="pseudo" class="form-control" placeholder="PSEUDO" <?php  ?>></td>
    </tr>
