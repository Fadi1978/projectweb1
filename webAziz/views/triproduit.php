                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="../food_menu.html"></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../chefs.html"></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../try/views/afficherpanier.php"></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../try/ajoutClient.html">S'</a>
                                </li>
...
$listeproduit=$produitsC->afficheOrderNom();
...
foreach($listeproduit as $row){
	...
	<td><a class="single_page_btn d-none d-sm-block" href="modifierproduit.php?id=<?PHP echo $row['id_produit']; ?>">
	Modifier</a></td>
	</tr>
	<?PHP
}
